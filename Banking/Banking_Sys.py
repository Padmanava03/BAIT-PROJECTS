...
con = cnt.connect(host="localhost", user="root",
                  password="Padwa@0308", database="bank")
...
def check_cus(cur):
    ...
    if (cur.rowcount > 0):
        ...
        print()
        print("===============================================================================================================================================")
        print("     Customer ID             Name            Gender              Account Number              Phone               Email ID               Address")
        print("===============================================================================================================================================")
        for row in d:
            print("    ", row[0], "    ", row[2],
                  row[3], row[1], row[5], row[6], row[4])
        print("===============================================================================================================================================")
